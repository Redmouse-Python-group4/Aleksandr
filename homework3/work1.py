#1 задание. Использование генератора списков. Бесполезное использование, но зато использовал.

x = int(input('Приветствую тебя, друже! Братуха введи число от 1 до 9: '))

num = [x for x in range (1,10)]
if x in num and x>=1 and x <=3:
